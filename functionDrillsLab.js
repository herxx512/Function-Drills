...
let offChecker = thatsOdd(2)
console.log(offChecker)
...
//CODE HERE
function theEliminator(con1,con2){
...
console.log(emailCheck(example))
...
let arrayIsAscending = ascendingOrNot(sampleArray)
